...
const SignIn: React.FC = () => {
  ...
  const submitHandler = async (e: any) => {
    ...
    if (result.meta.requestStatus === 'fulfilled') {
      if (result.payload.role === 'Admin') {
        navigate('/');
      } else if (result.payload.role === 'Staff') {
        navigate('/');
      } else {
        navigate('/');
      }
  ...
  return (
    <>
      ...
      <div
        className="rounded-sm border border-stroke bg-white dark:border-strokedark dark:bg-boxdark"
        style={{ height: '100vh' }}
      >
        <div className="flex flex-wrap items-center h-screen items-center justify-center">
            ...
            <div className="py-17.5 px-26 text-center">
              ...
              <div className="mb-5.5 inline-block">
                <svg
                  ...
                  class="lucide lucide-truck h-8 w-8 text-[var(--primary)]"
                >
              ...
              <p className="2xl:px-20">NTC Trucking - Truck Transportation</p>
